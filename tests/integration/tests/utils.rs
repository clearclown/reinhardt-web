// Auto-generated module file for utils integration tests
// Each test file in utils/ subdirectory is explicitly included with #[path] attribute

#[path = "utils/logging_orm_integration.rs"]
mod logging_orm_integration;

#[path = "utils/pagination_basic_integration.rs"]
mod pagination_basic_integration;

#[path = "utils/query_encoding_integration.rs"]
mod query_encoding_integration;

#[path = "utils/query_string_encoding_integration.rs"]
mod query_string_encoding_integration;
