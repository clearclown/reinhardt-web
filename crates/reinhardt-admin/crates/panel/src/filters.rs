...
///
/// ```
/// use reinhardt_panel::{ListFilter, FilterSpec};
///
/// struct StatusFilter {
///     field: String,
/// }
...
///
/// ```
/// use reinhardt_panel::{BooleanFilter, ListFilter};
///
...
///
/// ```
/// use reinhardt_panel::{ChoiceFilter, ListFilter};
///
...
///
/// ```
/// use reinhardt_panel::{DateRangeFilter, ListFilter};
///
...
///
/// ```
/// use reinhardt_panel::{NumberRangeFilter, ListFilter};
///
...
impl NumberRangeFilter {
	...
	///
	/// ```
	/// use reinhardt_panel::NumberRangeFilter;
	///
...
///
/// ```
/// use reinhardt_panel::{FilterManager, BooleanFilter, ChoiceFilter};
///
