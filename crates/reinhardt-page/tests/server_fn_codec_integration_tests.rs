//! Integration tests for Server Functions Codec System (Week 4 Day 3-4)
//!
...
use reinhardt_page::server_fn::codec::{Codec, JsonCodec, UrlCodec};
use serde::{Deserialize, Serialize};

#[cfg(feature = "msgpack")]
use reinhardt_page::server_fn::codec::MessagePackCodec;
