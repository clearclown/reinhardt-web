...
impl SerializationContext {
	...
	///
	/// ```
	/// use reinhardt_core_serializers::recursive::SerializationContext;
	///
...
pub mod circular {
	...
	///
	/// ```
	/// use reinhardt_core_serializers::recursive::{SerializationContext, circular};
	///
	/// struct User { id: i64 }
	/// let user = User { id: 1 };
	///
...
pub mod depth {
	...
	///
	/// ```
	/// use reinhardt_core_serializers::recursive::{SerializationContext, depth};
	///
	/// let context = SerializationContext::new(2);
